 ...
 <div class="row">
 	<div class="col">
 		<div class="panel panel-default">
			<div class="panel-heading"><h1>CHECK DIARLY</h1></div>
			<div class="panel-body">
				<h4>Check today, by maked information.</h4>
			</div>
 		</div>
 	</div>
</div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
		...
		<li><a href="/index.php/planning/">Planning</a></li>
     	...
     	<li class="active"><a href="#">Diarly<span class="sr-only">(current)</span></a></li>
      </ul>
