...
<div class="text-box">
	<h2>Our company surpport to you.</h2> 
	<h4>You can try learning, working or manythings.</h4>
...
<div class="button-box">
	<div class="container-fluid">
		<div class="row" style="background-color:#2c3e50;">
			<div class="col col-sm-6" style="padding:10px;">
				<a role="button" class="btn btn-md btn-info btn-block" href="/index.php/register/">Registration&nbsp;<span class="glyphicon glyphicon-briefcase"></span></a>
			</div>
			<div class="col col-sm-6" style="padding:10px;">
				<a role="button" class="btn btn-md btn-info btn-block" href="/index.php/login/">LOG IN&nbsp;<span class="glyphicon glyphicon-log-in"></span></a>
			</div>
		</div>
	</div>
</div>
