...
<?php echo form_open('login/forget/activationOn','class="form-horizontal"') ?>
			  ...
			  <div class="form-group" style="min-height: 140px;">
				<div class="col-sm-offset-2 col-sm-3">
				  <button type="submit" class="btn btn-default sub-btn">Reset password&nbsp;<span class="glyphicon glyphicon-refresh"></span></button> 
					...
					<div class="alert alert-info" role="alert">
						<p><span class="glyphicon glyphicon-info-sign"></span>&nbsp;Activation On. so reset password send your email.</p>
						<p>Please, Once Again, writting your email.</p>
					</div>
					</div>
			   </div>
			</form>	 
