...
<?php echo form_open('login/forget/activationOn','class="form-horizontal"') ?>
			  ...
			  <div class="form-group" style="min-height: 140px;">
				<div class="col-sm-offset-2 col-sm-3">
				  <a role="button" href="/index.php/login/forget/form" class="btn btn-default sub-btn">Reset password&nbsp;<span class="glyphicon glyphicon-refresh"></span></a> 
					...
					<div class="alert alert-info" role="alert">
						<p><span class="glyphicon glyphicon-alert"></span>&nbsp;&nbsp;Reset Password,Failed.</p> 
						<p>Reset password, Fail. try to again this task.</p> 
					</div>
					</div>
			   </div>
			</form>	 
