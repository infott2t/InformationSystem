...
<?php echo form_open('login/forget/activationOn','class="form-horizontal"') ?>
			  <div class="form-group">
				...
				<div class="col-sm-10" style="height:71px;">
				  <input type="email" name="email" disabled="disabled" class="form-control" id="inputEmail3" placeholder="Email">
				</div>
			  </div>
			
			  <div class="form-group" style="min-height: 140px;">
				<div class="col-sm-offset-2 col-sm-3">
				  <a role="button" href="/index.php/login/forget/form" class="btn btn-default sub-btn">Again Check, email</span></a> 
					...
					<div class="alert alert-info" role="alert">
						<p><span class="glyphicon glyphicon-alert"></span>&nbsp;&nbsp;Reset Password</p> 
						<p>Not matched before writtting. email address. Please, Check again.</p> 
					</div>
					</div>
			   </div>
			</form>	 
